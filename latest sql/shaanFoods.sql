...
GO 
ALTER TABLE [dbo].[orderDetails] WITH CHECK ADD CONSTRAINT [FK_orderDetails_customerOrder] FOREIGN KEY ([order_id])
REFERENCES [dbo].[customerOrder] ([order_id])
GO
ALTER TABLE [dbo].[orderDetails] CHECK CONSTRAINT [FK_orderDetails_customerOrder]
GO
ALTER TABLE [dbo].[orderDetails] WITH CHECK ADD CONSTRAINT [FK_orderDetails_productsCategory] FOREIGN KEY ([p_category_id])
REFERENCES [dbo].[productsCategory] ([p_category_id])
GO
ALTER TABLE [dbo].[orderDetails] CHECK CONSTRAINT [FK_orderDetails_productsCategory]
